...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=7),  # Extend token lifespan to 7 days
    'REFRESH_TOKEN_LIFETIME': timedelta(days=30),  # Refresh token valid for 30 days
    'ROTATE_REFRESH_TOKENS': False,  # Optional: Prevent refresh token rotation
    'BLACKLIST_AFTER_ROTATION': False,  # Optional: Prevent token blacklisting
}
